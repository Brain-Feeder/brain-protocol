-- RBFC Brain Protocol provider — Class D data layer (BP-02), as a Supabase migration.
-- Adapted verbatim from providers/real-bedford/db/schema.sql (the certified reference schema).
-- Only addition vs the local schema: pgcrypto for gen_random_uuid() (Supabase enables it on request).
